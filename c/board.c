...
static void Board_InitializePatternDiff(Board *self)
{
	...
	int pattern_list[][11] = {
		...
		{ A4, B3, C2, D1, -1 },
		{ E8, F7, G6, H5, -1 },
		{ B2, A1, B1, C1, D1, E1, F1, G1, H1, G2, -1 },
		{ B7, A8, B8, C8, D8, E8, F8, G8, H8, G7, -1 },
		{ B2, A1, A2, A3, A4, A5, A6, A7, A8, B7, -1 },
		{ G2, H1, H2, H3, H4, H5, H6, H7, H8, G7, -1 },
		{ C3, B3, A3, C2, B2, A2, C1, B1, A1, -1 },
		{ F3, G3, H3, F2, G2, H2, F1, G1, H1, -1 },
		{ C6, B6, A6, C7, B7, A7, C8, B8, A8, -1 },
		{ F6, G6, H6, F7, G7, H7, F8, G8, H8, -1 },
		{ -1 }
	};
